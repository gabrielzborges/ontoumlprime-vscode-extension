...
entryRulePrimitiveDataTypeType returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPrimitiveDataTypeTypeRule()); }
	iv_rulePrimitiveDataTypeType=rulePrimitiveDataTypeType
	{ $current=$iv_rulePrimitiveDataTypeType.current; }
	EOF;

// Rule PrimitiveDataTypeType
rulePrimitiveDataTypeType returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	otherlv_0='PrimitiveDataTypeType'
	{
