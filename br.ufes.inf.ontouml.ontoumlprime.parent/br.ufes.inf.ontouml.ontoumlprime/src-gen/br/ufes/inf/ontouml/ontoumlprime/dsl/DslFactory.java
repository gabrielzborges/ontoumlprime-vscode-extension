...
public interface DslFactory extends EFactory
{
   ...
   * @generated
   */
  DslFactory eINSTANCE = br.ufes.inf.ontouml.ontoumlprime.dsl.impl.DslFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Endurant Universal</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Endurant Universal</em>'.
   * @generated
   */
  EndurantUniversal createEndurantUniversal();
  ...
  /**
   * Returns a new object of class '<em>Intrinsic Moment Universal</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Intrinsic Moment Universal</em>'.
   * @generated
   */
  IntrinsicMomentUniversal createIntrinsicMomentUniversal();

  /**
   * Returns a new object of class '<em>Externally Dependent Universal</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Externally Dependent Universal</em>'.
   * @generated
   */
  ExternallyDependentUniversal createExternallyDependentUniversal();
  ...
  /**
   * Returns a new object of class '<em>Substantial Universal</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Substantial Universal</em>'.
   * @generated
   */
  SubstantialUniversal createSubstantialUniversal();
  ...
  /**
   * Returns a new object of class '<em>Primitive Data Type Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Primitive Data Type Type</em>'.
   * @generated
   */
  PrimitiveDataTypeType createPrimitiveDataTypeType();
