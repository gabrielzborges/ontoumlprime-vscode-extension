 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getSourceLowerBound <em>Source Lower Bound</em>}</li>
 *   <li>{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getSourceUpperBound <em>Source Upper Bound</em>}</li>
 *   <li>{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getTarget <em>Target</em>}</li>
 *   <li>{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getTargetLowerBound <em>Target Lower Bound</em>}</li>
 *   <li>{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getTargetUpperBound <em>Target Upper Bound</em>}</li>
 * </ul>
 *
 * @see br.ufes.inf.ontouml.ontoumlprime.dsl.DslPackage#getCharacterization()
 * @model
 * @generated
 */
public interface Characterization extends EObject
{
   ...
   * @see br.ufes.inf.ontouml.ontoumlprime.dsl.DslPackage#getCharacterization_SourceLowerBound()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getSourceLowerBound <em>Source Lower Bound</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see br.ufes.inf.ontouml.ontoumlprime.dsl.DslPackage#getCharacterization_SourceUpperBound()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getSourceUpperBound <em>Source Upper Bound</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see br.ufes.inf.ontouml.ontoumlprime.dsl.DslPackage#getCharacterization_Target()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getTarget <em>Target</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see br.ufes.inf.ontouml.ontoumlprime.dsl.DslPackage#getCharacterization_TargetLowerBound()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getTargetLowerBound <em>Target Lower Bound</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see br.ufes.inf.ontouml.ontoumlprime.dsl.DslPackage#getCharacterization_TargetUpperBound()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link br.ufes.inf.ontouml.ontoumlprime.dsl.Characterization#getTargetUpperBound <em>Target Upper Bound</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
